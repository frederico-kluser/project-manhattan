...
describe('variable keyCodeLettersEnum', () => {
  it('keyCodeLettersEnum have exactly...', () => {
    ...
    expect(keyCodeLettersEnum).toMatchObject(localKeyCodeLettersEnum);
  });
});
...
describe('variable keyCodeNumbersEnum', () => {
  it('keyCodeNumbersEnum have exactly...', () => {
    ...
    expect(keyCodeNumbersEnum).toMatchObject(localKeyCodeNumbersEnum);
  });
});
...
describe('variable keyCodeCommandsEnum', () => {
  it('enums have exactly...', () => {
    ...
    const localKeyCodeCommandsEnum = {
      13: 'enter',
      8: 'backspace',
    };

    expect(keyCodeCommandsEnum).toMatchObject(localKeyCodeCommandsEnum);
  });
});
